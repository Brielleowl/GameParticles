...
Particle::Particle():life(0.0f), position(0.0f, 0.0f, 0.0f), velocity(0.0f, 0.0f, 0.0f), scale(1.0f, 1.0f, 1.0f), rotation(0.0f), rotation_velocity(0.25f)
{
	// construtor
	/*this->life = 0.0f;
